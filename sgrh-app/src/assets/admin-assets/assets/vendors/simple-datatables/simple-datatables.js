    ...
    1: [function (require, module, exports) {
      (function (global) {
        ...
        var dayjs_min = createCommonjsModule(function (t, n) {
          t.exports = function () {
            var t = "millisecond", n = "second", e = "minute", r = "hour", i = "day", s = "week", o = "month",
              a = "quarter", u = "year",
              ...
              c = function (t, n, e) {
                ...
                s: c, z: function (t) {
                  ...
                  var e = 12 * (n.year() - t.year()) + (n.month() - t.month()), r = t.clone().add(e, o), i = n - r < 0,
            ...
            var v = function () {
              ...
              return d.parse = function (t) {
                ...
                if (c === i) return d(1);
                if (c === s) return d(7);
                var l = (h = {}, h[e] = 6e4, h[r] = 36e5, h[n] = 1e3, h)[c] || 1, m = this.valueOf() + t * l;
                return g.w(m, this)
                ...
                var e = t || "YYYY-MM-DDTHH:mm:ssZ", r = g.z(this), i = this.$locale(), s = this.$H, o = this.$m,
                  a = this.$M, u = i.weekdays, h = i.months, c = function (t, r, i, s) {
          ...
          t.exports = (r = /(\[[^[]*\])|([-:\/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, o = /\d*[^\s\d-:\/.()]+/, u = [/[+-]\d\d:?\d\d/, function (t) {
            ...
            try {
              ...
              var m = new Date, $ = s || m.getFullYear(), M = o > 0 ? o - 1 : m.getMonth(), D = a || m.getDate(),
                y = u || 0, g = f || 0, v = c || 0, p = d || 0;
      ...
      class DataTable {
        ...
        renderPager() {
          if (flush(this.pagers), this.totalPages > 1) {
            const t = "pager", e = document.createDocumentFragment(), s = this.onFirstPage ? 1 : this.currentPage - 1,
        ...
        print() {
          const t = this.activeHeadings, e = this.activeRows, s = createElement("table"), a = createElement("thead"),
            i = createElement("tbody"), n = createElement("tr");
          t.forEach(t => {
